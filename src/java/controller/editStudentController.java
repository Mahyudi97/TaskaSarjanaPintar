    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Parent P = ParentDA.authenticateParent(parentAddress,fatherName,fatherIC,fatherContactNum,fatherOccupation,fatherOccupAddress,motherName,motherIC,motherContactNum,motherOccupation,motherOccupAddress,3);
               // out.println(P.getMotherName());
                //out.println(motherName);
                Student S = StudentDA.authenticateStudent(studName,studIC,studAge,studGender,studBirthCertificate,P.getParentId(),3);
